...
- [Post-process predictions](post-process-output.md) - `FilterControl` and `myogestic.outputs.filters` for output smoothing.
- [Integrate the Virtual Hand](integrate-vhi.md) - `myogestic.vhi.interfaces.virtual_hand` and the launcher pattern.
