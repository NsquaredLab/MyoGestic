...
- [Integrate your own interface](integrate-your-interface.md) - build a renderer for a device of your own, in seven stages, each ending in something you run and watch. The gRPC + LSL route, for a device that is its own application.
