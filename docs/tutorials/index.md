...
- [Your first remote target](your-first-remote-target.md) - build a remote target for a device of your own, in seven stages, each ending in something you run and watch. The gRPC + LSL route, for a device that is its own application.
