...
Explanation of how MyoGestic fits together. Read these once to understand the runtime model; the [guides](../how-to/index.md) and [API reference](../api/index.md) become much easier afterwards.
