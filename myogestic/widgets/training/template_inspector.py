...
class TemplateInspector:
    ...
    ----------
    widget_id
        Stable identity string. Two inspectors with the same widget_id share
        selection state; different widget_ids are independent.
    title
    ...
    def ui(self, rows: list[TemplateInspectorRow]) -> str | None:
        ...
        title = self._title
        height = self._height
        label_colors = self._label_colors or {}
