...
# The mains notch lives in the core: `Stream` conditions acquisition with it, and
# core must not import from `widgets`. Re-exported here so the viewer's own imports
# and its tests keep working unchanged.
from myogestic.conditioning import (  # noqa: F401
    _NOTCH_BW_HZ,
    _NOTCH_MAX_LINES,
    NotchFilter,
    apply_mains_notch,
