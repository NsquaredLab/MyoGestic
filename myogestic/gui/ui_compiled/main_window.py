...
"color: rgb(0, 0, 0);")
        ...
        sizePolicy6.setHeightForWidth(self.vispyPlotWidget.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy5.setHeightForWidth(self.toggleVispyPlotCheckBox.sizePolicy().hasHeightForWidth())
